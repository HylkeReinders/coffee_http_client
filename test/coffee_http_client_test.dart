  ...
  group('CoffeeHttp (with injected adapter)', () {
    test('request() merges headers in correct order', () async {
      ...
      final req = CoffeeRequest(
        ...
        path: '/x',
        headers: const {'A': 'request', 'C': 'request'},
      );
    ...
    test(
      'request() maps TimeoutException to CoffeeHttpErrorKind.timeout and calls onError',
      () async {
    ...
    test(
      'getHandled<T>() uses handleResponse and returns typed result',
      () async {
        final adapter = _FixedAdapter(
          CoffeeRawResponse(
            statusCode: 200,
        ...
        final client = CoffeeHttp.create(
          CoffeeHttpConfig(
            ...
            hooks: CoffeeHooks(
              handleResponse: (ctx) => <String, dynamic>{
    ...
    test(
      ...
      () async {
        ...
        expect(
          () => client.getHandled<Map<String, dynamic>>('/x'),
